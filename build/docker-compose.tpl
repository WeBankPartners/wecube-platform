...
services:
  ...
  platform-gateway:
    ...
    environment:
      ...
      - GATEWAY_ROUTES_PLATFORM_CORE_PREDICATE_PATH={{GATEWAY_ROUTES_PLATFORM_CORE_PREDICATE_PATH}}
      - GATEWAY_ROUTES_PLATFORM_CORE_FILTERS_DYNROUTE={{GATEWAY_ROUTES_PLATFORM_CORE_FILTERS_DYNROUTE}}
