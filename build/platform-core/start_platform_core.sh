#!/bin/sh
mkdir -p /log
java -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=${WECUBE_CORE_JMX_PORT} -Dcom.sun.management.jmxremote.rmi.port=9080 -Dcom.sun.management.jmxremote.authenticate=false \
