...
import com.webank.wecube.core.domain.PackageDomain;
...
import com.webank.wecube.core.support.cmdb.dto.v2.PaginationQuery.Dialect;
...
import com.webank.wecube.core.support.plugin.dto.PluginRequest.DefaultPluginRequest;
...
public class ArtifactService {
    ...
    public Object getCurrentDirs(String packageId, String currentDir) {
        ...
        inputs.add(ImmutableMap.<String, Object>builder()
                ...
                .put("accessKey", s3Properties.getAccessKey())
                .put("secretKey", s3Properties.getSecretKey())
                .put("currentDir", currentDir).build());
        request.setInputs(inputs);

        return pluginServiceStub.getPluginReleasedPackageFilesByCurrentDir(pluginInstanceService.getInstanceAddress(instances.get(0)), request);
    }
    ...
    public Object getPropertyKeys(String packageId, String filePath) {
        ...
        return pluginServiceStub.getPluginReleasedPackagePropertyKeysByFilePath(pluginInstanceService.getInstanceAddress(instances.get(0)), request);
    }
    ...
    public Object getArtifactSystemDesignTree(String systemDesignId) {
        ...
        if (fixedDate != null) {
            List<CiDataTreeDto> dtos = cmdbServiceV2Stub.getCiDataDetailForVersion(
                    cmdbDataProperties.getCiTypeIdOfSystemDesign(),
    ...
    public void saveDiffConfigEnumCodes(CatCodeDto requestCode) {
        ...
        if (cat == null) {
            throw new WecubeCoreException(String.format("Can not find cat with name [%s].", cmdbDataProperties.getEnumCategoryNameOfDiffConf()));
        }
