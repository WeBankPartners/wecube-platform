...
import com.webank.wecube.core.service.workflow.parse.CustomSpringProcessEngineConfiguration;
...
public class CustomBpmConfig {
    ...
    public ProcessEngineConfigurationImpl processEngineConfigurationImpl(
        ...
        log.info("configure process engine configuration impl,class={}", CustomSpringProcessEngineConfiguration.class.getName());
