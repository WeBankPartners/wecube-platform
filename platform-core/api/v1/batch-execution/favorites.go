...
func CreateOrUpdateFavorites(c *gin.Context) {
	...
	reqParam := models.CreateOrUpdateFavoritesReq{}
	var err error
	...
	err = database.CreateOrUpdateFavorites(c, &reqParam)
	if err != nil {
...
func RetrieveFavorites(c *gin.Context) {
