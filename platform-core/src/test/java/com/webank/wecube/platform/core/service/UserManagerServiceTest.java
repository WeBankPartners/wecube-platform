...
public class UserManagerServiceTest extends BaseSpringBootTest {
    ...
    public void givenMultipleVersionPackagesWithMenuWhenFindAllForAllActivePackagesThenReturnOnlyMenusForActivePackages() {
        {
            ...
            pluginPackageRepository.saveAll(Lists.newArrayList(unregisteredPluginPackage, runningPluginPackage, stoppedPluginPackage, decommissionedPluginPackage));

            List<MenuItemDto> allMenus = userManagerService.getAllMenus();
