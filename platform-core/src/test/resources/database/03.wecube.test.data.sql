...
INSERT INTO `plugin_package_menus` (`id`, `plugin_package_id`, `code`, `category`, source, menu_order, `display_name`, `local_display_name`, `path`) VALUES ('JOBS__JOBS_SERVICE_CATALOG_MANAGEMENT', '25', 'JOBS_SERVICE_CATALOG_MANAGEMENT', 'JOBS', 'PLUGIN', 1, 'Servive Catalog Management', '服务类型管理', '/service-catalog');
INSERT INTO `plugin_package_menus` (`id`, `plugin_package_id`, `code`, `category`, source, menu_order, `display_name`, `local_display_name`, `path`) VALUES ('JOBS__JOBS_TASK_MANAGEMENT', '25', 'JOBS_TASK_MANAGEMENT', 'JOBS', 'PLUGIN', 2, 'Task Management', '任务管理', '/task-management');
