...
INSERT INTO `system_variables` (`id`, `plugin_package_id`, `name`, `value`, `default_value`, `scope_type`, `scope_value`, `seq_no`, `status`) VALUES (3, 'service-mgmt__v1.0', 'ALLOCATE_PORT', NULL, '20000', 'plugin-package', NULL, 0, 'active');
INSERT INTO `system_variables` (`id`, `plugin_package_id`, `name`, `value`, `default_value`, `scope_type`, `scope_value`, `seq_no`, `status`) VALUES (4, 'service-mgmt__v1.0', 'ALLOCATE_HOST', NULL, NULL, 'plugin-package', NULL, 0, 'active');
