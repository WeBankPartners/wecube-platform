...
INSERT INTO `system_variables` (`id`, `plugin_package_id`, `name`, `value`, `default_value`, `scope_type`, `scope_value`, `status`) VALUES (1, NULL, 'CORE_ADDR', NULL, 'http://127.0.0.1:19090', 'global', NULL, 'active');
INSERT INTO `system_variables` (`id`, `plugin_package_id`, `name`, `value`, `default_value`, `scope_type`, `scope_value`, `status`) VALUES (2, NULL, 'BASE_MOUNT_PATH', NULL, '/data', 'global', NULL, 'active');
INSERT INTO `system_variables` (`id`, `plugin_package_id`, `name`, `value`, `default_value`, `scope_type`, `scope_value`, `status`) VALUES (3, 'service-mgmt__v1.0', 'ALLOCATE_PORT', NULL, '20000', 'plugin-package', NULL, 'active');
INSERT INTO `system_variables` (`id`, `plugin_package_id`, `name`, `value`, `default_value`, `scope_type`, `scope_value`, `status`) VALUES (4, 'service-mgmt__v1.0', 'ALLOCATE_HOST', NULL, NULL, 'plugin-package', NULL, 'active');
