...
/**
 * <p>
 * Java class for paramObjectType complex type.
 * 
 * <p>
...
@XmlType(name = "paramObjectType", propOrder = { "property" })
public class ParamObjectType {

    @XmlAttribute(name = "name", required = true)
    protected String name;

    @XmlAttribute(name = "packageName", required = false)
     ...
     * 
     * @return possible object is {@link ParamPropertyType }
     * 
     */
