...
import com.webank.wecube.platform.core.service.CmdbResourceService;
...
//    @RolesAllowed({MENU_ADMIN_CMDB_MODEL_MANAGEMENT})
    ...
    @ResponseBody
    public JsonResponse createEnumCategory(
            @PathVariable(value = "category-type-id", required = false) Integer categoryTypeId,
...
//    @RolesAllowed({MENU_ADMIN_CMDB_MODEL_MANAGEMENT})
    ...
    @ResponseBody
    public JsonResponse getEnumCategoriesByTypes(@RequestParam(name = "types") String types,
            @RequestParam(name = "ci-type-id", required = false) Integer ciTypeId) {
...
//    @RolesAllowed({MENU_ADMIN_CMDB_MODEL_MANAGEMENT})
    ...
    @ResponseBody
    public JsonResponse updateEnumCategory(
            @PathVariable(value = "category-type-id", required = false) Integer categoryTypeId,
...
//    @RolesAllowed({MENU_ADMIN_CMDB_MODEL_MANAGEMENT, MENU_ADMIN_BASE_DATA_MANAGEMENT, MENU_IMPLEMENTATION_ARTIFACT_MANAGEMENT})
    ...
    @ResponseBody
    public JsonResponse createEnumCode(
            @PathVariable(value = "category-type-id", required = false) Integer categoryTypeId,
            @PathVariable(value = "category-id", required = false) Integer categoryId,
...
//            MENU_DESIGNING_PLANNING, MENU_DESIGNING_RESOURCE_PLANNING, MENU_DESIGNING_CI_INTEGRATED_QUERY_EXECUTION, MENU_IMPLEMENTATION_BATCH_JOB})
    ...
    @ResponseBody
    public JsonResponse updateEnumCode(
            @PathVariable(value = "category-type-id", required = false) Integer categoryTypeId,
            @PathVariable(value = "category-id", required = false) Integer categoryId,
            @PathVariable(value = "code-id", required = false) Integer codeId, @RequestBody CatCodeDto catCodeDto) {
...
//    @RolesAllowed({MENU_ADMIN_CMDB_MODEL_MANAGEMENT})
    ...
    @ResponseBody
    public JsonResponse swapCiTypeLayerPosition(@PathVariable(value = "layer-id") int layerId,
            @RequestParam(value = "target-layer-id") int targetLayerId) {
...
//    @RolesAllowed({MENU_ADMIN_CMDB_MODEL_MANAGEMENT, MENU_ADMIN_BASE_DATA_MANAGEMENT})
    ...
    @ResponseBody
    public JsonResponse queryEnumCodes(
            @PathVariable(value = "category-type-id", required = false) Integer categoryTypeId,
            @PathVariable(value = "category-id") Integer categoryId, @RequestBody PaginationQuery queryObject) {
