...
public interface TaskNodeDefInfoRepository
		extends JpaRepository<TaskNodeDefInfoEntity, String> {
	
	List<TaskNodeDefInfoEntity> findTaskServicesByProcDefKeyAndVersion(String procDefKey, Integer version);
	
	List<TaskNodeDefInfoEntity> findTaskServicesByProcDefKeyAndVersionAndTaskNodeId(String procDefKey, Integer version, String taskNodeId);
