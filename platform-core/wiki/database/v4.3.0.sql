...
INSERT INTO system_variables (id, package_name, name, value, default_value, `scope`, source, status) VALUES ('system__global__PLATFORM_IMPORT_SYSTEM_DEPLOY_ATTR', '', 'PLATFORM_IMPORT_SYSTEM_DEPLOY_ATTR', '', 'domain_deploy_batch_no,deploy_batch_no', 'global','system', 'active');
INSERT INTO system_variables (id, package_name, name, value, default_value, `scope`, source, status) VALUES ('system__global__PLATFORM_IMPORT_CONFIRM_VIEW_LIST', '', 'PLATFORM_IMPORT_CONFIRM_VIEW_LIST', '', 'network_design,deploy_zone_design,system_design', 'global','system', 'active');

INSERT INTO system_variables (id, package_name, name, value, default_value, `scope`, source, status) VALUES ('system__global__PLATFORM_IMPORT_CONFIRM_CI_LIST', '', 'PLATFORM_IMPORT_CONFIRM_CI_LIST', '', 'application_domain', 'global','system', 'active');
INSERT INTO system_variables (id, package_name, name, value, default_value, `scope`, source, status) VALUES ('system__global__PLATFORM_IMPORT_UPDATE_CI_LIST', '', 'PLATFORM_IMPORT_UPDATE_CI_LIST', '', 'basic_security_policy', 'global','system', 'active');
