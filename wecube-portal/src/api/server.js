...
export const addRole = data => req.post(`/platform/v1/admin/roles/create`, data)
export const addUser = data => req.post(`/platform/v1/admin/users/create`, data)
...
export const operateCiState = (ciTypeId, guid, op) => {
  ...
  return req.post(`/platform/v1/cmdb/ci/state/operate?operation=${op}`, payload)
}
