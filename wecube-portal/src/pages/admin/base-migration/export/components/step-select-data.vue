<template>
  <div class="export-step-data">
    ...
    <div class="item">
      <span class="title">
        监控配置：<span class="sub-title">已选配置类型<span class="number">{{ detailData.monitorRes.data.length }}</span> <span class="name">总条数</span><span class="number">{{ detailData.monitorCount }}</span>
        </span>
      </span>
      <Row :gutter="10">
        <Col :span="12">
